...
class RegistrationViewModel @Inject constructor(
    ...
    // Updated signUp function signature and added username validation
    fun signUp(username: String, email: String, password: String, confirmPassword: String) {
        ...
        if (username.isEmpty()) {
            ...
            // Clear username error if it passes, keep other errors if they were set by other validations in this attempt
        ...
        // All local validations passed, proceed to repository call
